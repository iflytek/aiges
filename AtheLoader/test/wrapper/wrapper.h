...
typedef const char* (WrapperAPI *wrapperCreatePtr)(pParamList params, wrapperCallback cb, unsigned int psrIds[], int psrCnt, int* errNum);
...
typedef int (WrapperAPI *wrapperWritePtr)(const char* handle, pDataList reqData);
...
typedef int (WrapperAPI *wrapperReadPtr)(const char* handle, pDataList* respData);
...
typedef int (WrapperAPI *wrapperDestroyPtr)(const char* handle);
...
typedef int (WrapperAPI *wrapperExecAsyncPtr)(const char* handle, pParamList params, pDataList reqData, wrapperCallback callback, int timeout);
...
typedef const char* (WrapperAPI *wrapperDebugInfoPtr)(const char* handle);
