...
To use lumberjack with the standard library's log package, just pass it into the SetOutput function when your application starts.This is a async example.
...
log.SetOutput(&lumberjack.Logger{
    ...
    Async: true,  //async. logger. U can set in false,if you want a sync. logger
    CacheMaxCount: -1,
	BatchSize:50,
	
})
log.Start()  // strat background goroutine that flush buffer in filies
```
