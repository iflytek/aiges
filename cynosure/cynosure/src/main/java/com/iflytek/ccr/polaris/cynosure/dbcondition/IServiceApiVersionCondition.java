 ...
 **/
public interface IServiceApiVersionCondition {
    /**
     * 查询版本总数
     *
     * @param map
     ...
     * @return
     */
    List<ServiceApiVersion> findList(List<String> serviceIds);
     ...
     * @return
     */
    ServiceApiVersion add(AddServiceApiVersionRequestBody body);
     ...
     * @return
     */
    ServiceApiVersion updateById(String id, EditServiceVersionRequestBody body);
     ...
     * @return
     */
    ServiceApiVersion find(String version, String serviceId);
