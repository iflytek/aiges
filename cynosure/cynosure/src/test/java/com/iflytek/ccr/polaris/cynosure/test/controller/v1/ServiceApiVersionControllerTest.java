...
public class ServiceApiVersionControllerTest {
    @Autowired
    ...
    public void test_service_version_3_delete() throws Exception {
        ...
        body.setId("3786487492958486528");
        String result = this.mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/service/apiVersion/delete")
                .content(JSON.toJSONString(body))
                .contentType(MediaType.APPLICATION_JSON)
                .session((MockHttpSession) Utils.getLoginSession(this.mockMvc))
                .accept(MediaType.APPLICATION_JSON))
