...
public class ConfigTest5 {
    ...
    static String gray_data = "[{\"group_id\":\"gray1\",\"server_list\":[\"c1\"]}]";
    static String changed_gray_data = "[{\"group_id\":\"gray2\",\"server_list\":[]}]";
    ...
    public void test() throws Exception {
        ...
        Thread.sleep(1000);
        //取消订阅changedConfig 应该为null
        finderManager.unSubscribeConfig("a.cfg");
        Thread.sleep(1000);
        changeFile();
        Assert.assertEquals(null,changedConfig);
    ...
    private void changeFile() throws InterruptedException {
        Thread.sleep(2000);
          zkHelper.update(baseConfigPath+"/gray/gray1/a.cfg",ByteUtil.getZkBytes(a_cfg_gray_1.getBytes(),"1234567890"));
