...
type WrapperServiceClient interface {
	...
	WrapperCreate(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Handle, error)
	WrapperWrite(ctx context.Context, in *WriteMessage, opts ...grpc.CallOption) (*Ret, error)
	WrapperDestroy(ctx context.Context, in *Handle, opts ...grpc.CallOption) (*Ret, error)
...
func (c *wrapperServiceClient) WrapperCreate(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Handle, error) {
	out := new(Handle)
	err := c.cc.Invoke(ctx, "/aiges.WrapperService/wrapperCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperServiceClient) WrapperWrite(ctx context.Context, in *WriteMessage, opts ...grpc.CallOption) (*Ret, error) {
	out := new(Ret)
	err := c.cc.Invoke(ctx, "/aiges.WrapperService/wrapperWrite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperServiceClient) WrapperDestroy(ctx context.Context, in *Handle, opts ...grpc.CallOption) (*Ret, error) {
	out := new(Ret)
	err := c.cc.Invoke(ctx, "/aiges.WrapperService/wrapperDestroy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WrapperServiceServer interface {
	...
	WrapperCreate(context.Context, *CreateRequest) (*Handle, error)
	WrapperWrite(context.Context, *WriteMessage) (*Ret, error)
	WrapperDestroy(context.Context, *Handle) (*Ret, error)
...
func (UnimplementedWrapperServiceServer) WrapperCreate(context.Context, *CreateRequest) (*Handle, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WrapperCreate not implemented")
}
func (UnimplementedWrapperServiceServer) WrapperWrite(context.Context, *WriteMessage) (*Ret, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WrapperWrite not implemented")
}
func (UnimplementedWrapperServiceServer) WrapperDestroy(context.Context, *Handle) (*Ret, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WrapperDestroy not implemented")
}
...
func _WrapperService_WrapperCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WrapperServiceServer).WrapperCreate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aiges.WrapperService/wrapperCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WrapperServiceServer).WrapperCreate(ctx, req.(*CreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _WrapperService_WrapperWrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WriteMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WrapperServiceServer).WrapperWrite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aiges.WrapperService/wrapperWrite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WrapperServiceServer).WrapperWrite(ctx, req.(*WriteMessage))
	}
	return interceptor(ctx, in, info, handler)
}

func _WrapperService_WrapperDestroy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Handle)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WrapperServiceServer).WrapperDestroy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aiges.WrapperService/wrapperDestroy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WrapperServiceServer).WrapperDestroy(ctx, req.(*Handle))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WrapperService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "wrapperCreate",
			Handler:    _WrapperService_WrapperCreate_Handler,
		},
		{
			MethodName: "wrapperWrite",
			Handler:    _WrapperService_WrapperWrite_Handler,
		},
		{
			MethodName: "wrapperDestroy",
			Handler:    _WrapperService_WrapperDestroy_Handler,
		},
	},
